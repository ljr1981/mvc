...
feature -- Converters
	...
	on_model_to_view_date_converter_agent (a_model: REAL): STRING_32
			-- Convert from DECIMAL to STRING_32
		do
			Result := a_model.out.to_string_32
		end

	on_view_to_model_date_converter_agent (a_text: STRING_32): REAL
